...
export default function Home() {
  ...
  return <div className="min-h-[100vh] w-[100%] flex flex-col bg-[var(--seashell)] ">
    ...
    {loading? <Loader tailwind="w-screen h-[60vh]"></Loader>:<main className="flex-1 flex flex-col lg:flex-row justify-around px-2 lg:items-center">
      ...
      <div id="descripcion" className="px-10 lg:ml-8 ">
        <h2 className="lg:block hidden lg:pl-4 lg:text-[3vh]"><b>Bienvenido a nuestra <br/> querida biblioteca</b></h2>
        <p className="lg:text-start text-center px-4 py-6 lg:text-[1.7vh]"><b>Con 70 años de historia</b>, somos un espacio dedicado al conocimiento y al entretenimiento, con un catálogo muy amplio que abarca desde literatura clásica hasta ciencia, arte, historia y mucho más.<br/><br/>
