    ...
    return <div className="relative w-fit m-2 my-6">
        ...
        <div className="hidden lg:flex lg:flex-col lg:pr-4">
            ...
            <div className="flex flex-row">
                <img className="flex-shrink relative z-20 max-w-[22rem] h-auto object-contain lg:max-w-[40vw]" src={evento.imagen_url} alt="Imagen del evento"></img>
                <p className="elemento-con-scroll overflow-y-auto max-h-[32vh] min-w-[9rem] w-full whitespace-pre-line flex-1 relative z-20 text-[var(--seashell)] text-[1.3vh] leading-loose ml-4 mt-6 mr-8">{evento.descripcion}</p>
            </div>
            <p className="ml-20 relative z-20 text-center py-8 text-[1.7vh]">{evento.titulo}</p>
        </div>
