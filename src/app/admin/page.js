    ...
    return <div className="h-[100vh] flex flex-col font-admin">
        ...
        <main className="bg-[var(--aliceBlue)] flex-1 flex flex-col p-8  text-[var(--paynesGray)] ">
            <div className="flex-1 grid gap-8 lg:gap-x-12 lg:mx-24 grid-cols-4 md:grid-cols-6 m-6 py-12 lg:py-0 justify-center">
                <div onClick={() => alert("No implementado") /*router.push("/addLibro")*/} className="lg:justify-around lg:py-4 px-6 col-span-2 flex flex-col p-5 rounded-2xl lg:flex-row bg-[var(--columbiaBlue)] items-center justify-center">
                ...
                <div onClick={() => alert("No implementado") /*router.push("/addEvento")*/} className="lg:justify-around lg:py-4 px-6 col-span-2 flex flex-col p-5 rounded-2xl lg:flex-row bg-[var(--columbiaBlue)] items-center justify-center">
                ...
                <div onClick={() => alert("No implementado") /*router.push("/verUsuarios")*/} className="lg:justify-around lg:py-4 px-6 col-span-2 flex flex-col p-5 rounded-2xl lg:flex-row bg-[var(--columbiaBlue)] items-center justify-center ">
                ...
                <div onClick={() => alert("No implementado") /*router.push("/nuevoPrestamo")*/} className="lg:justify-around lg:py-8 px-6 col-span-2 md:col-start-2 flex flex-col p-5 rounded-2xl lg:flex-row bg-[var(--columbiaBlue)] items-center justify-center">
                ...
                <div onClick={() => alert("No implementado") /*router.push("/nuevoDevolucion")*/} className="lg:justify-start lg:py-8 px-6 col-span-2 col-start-2 md:col-start-4 flex flex-col p-5 rounded-2xl lg:flex-row bg-[var(--columbiaBlue)] items-center justify-center">
